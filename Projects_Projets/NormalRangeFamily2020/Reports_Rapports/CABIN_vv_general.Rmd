...
This report presents the results for verification and validation of a general CABIN data file associated to the project **`r paste(datasetName)`**.
...
freq.table.taxonomist <- freq.table[freq.table$Variable=="Taxonomist",]
freq.table.taxonomist$Variable <- NULL
datatable(freq.table.taxonomist, filter = "top", rownames =F, options = list(scrollX = TRUE ))
}
...
{
freq.table.study <- freq.table[freq.table$Variable=="Study",]
freq.table.study$Variable <- NULL
datatable(freq.table.study, filter = "top", rownames =F, options = list(scrollX = TRUE ))
}
...
{
freq.table.sites <- freq.table[freq.table$Variable=="Site",]
freq.table.sites$Variable <- NULL
datatable(freq.table.sites, filter = "top", rownames =F, options = list(scrollX = TRUE ))
}
...
{
freq.table.date <- freq.table[freq.table$Variable=="SampleDate",]
freq.table.date$Variable <- NULL
datatable(freq.table.date, filter = "top", rownames =F, options = list(scrollX = TRUE ))
}
...
{
freq.table.year <- freq.table[freq.table$Variable=="Year",]
freq.table.year$Variable <- NULL
datatable(freq.table.year, filter = "top", rownames =F, options = list(scrollX = TRUE ) )
}
...
{
freq.table.day <- freq.table[freq.table$Variable=="JulianDay",]
freq.table.day$Variable <- NULL
datatable(freq.table.day, filter = "top", rownames =F, options = list(scrollX = TRUE ))
}
...
{
freq.table.rivername <- freq.table[freq.table$Variable=="Name",]
freq.table.rivername$Variable <- NULL
datatable(freq.table.rivername, filter = "top", rownames =F, options = list(scrollX = TRUE ))
}
...
{
freq.table.basin <- freq.table[freq.table$Variable=="Basin",]
freq.table.basin$Variable <- NULL
datatable(freq.table.basin, filter = "top", rownames =F, options = list(scrollX = TRUE ))
}
...
{
freq.table.watershed <- freq.table[freq.table$Variable=="KywName",]
freq.table.watershed$Variable <- NULL
datatable(freq.table.watershed, filter = "top", rownames =F, options = list(scrollX = TRUE ))
}
...
{
freq.table.ecoregion <- freq.table[freq.table$Variable=="Ecoregion",]
freq.table.ecoregion$Variable <- NULL
datatable(freq.table.ecoregion, filter = "top", rownames =F, options = list(scrollX = TRUE ))
}
...
{
freq.table.province <- freq.table[freq.table$Variable=="Province",]
freq.table.province$Variable <- NULL
datatable(freq.table.province, filter = "top", rownames =F, options = list(scrollX = TRUE ))
}
...
{
freq.table.device <- freq.table[freq.table$Variable=="Device",]
freq.table.device$Variable <- NULL
datatable(freq.table.device, filter = "top", rownames =F, options = list(scrollX = TRUE ))
}
...
{
freq.table.SampleStatus <- freq.table[freq.table$Variable=="SampleStatus",]
freq.table.SampleStatus$Variable <- NULL
datatable(freq.table.SampleStatus, filter = "top", rownames =F, options = list(scrollX = TRUE ))
}
...
{
freq.table.streamOrder <- freq.table[freq.table$Variable=="StreamOrder",]
freq.table.streamOrder$Variable <- NULL
datatable(freq.table.streamOrder, filter = "top", rownames =F, options = list(scrollX = TRUE ))
}
...
dataset.GEN2$Site_Date_Number <- paste(dataset.GEN2$Site, "_", dataset.GEN2$SampleDate, "_", dataset.GEN2$SampleId)
...
**CABIN_vv_general.Rmd Version 1.3 — September 20, 2019**
