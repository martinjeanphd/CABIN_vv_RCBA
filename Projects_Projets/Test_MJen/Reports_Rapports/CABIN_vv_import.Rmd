---
title: "CABIN Import Data"
author: "Martin Jean and Éva Charbonneau-Bérubé"
output:
  html_notebook:
    number_sections: yes
    toc: yes
...
datasetName <- svDialogs::dlgInput("Enter dataset name:", default = "Test", Sys.info()["datasetName"])$res
if(is.null(datasetName) | length(datasetName) == 0) {datasetName = "Test"} else {if(datasetName == "NA") {datasetName <- "Test"}}
...
|    Date    | Version |      Description              |  Approval   | Date approved      |#<br>
|:-----------|:-------:|:------------------------------|:-----------:|:------------------:|<br>
| 2019-08-23 | 2.1     |Code optimization and dialogs  |             |                    |<br>
| 2019-05-09 | 2.01    |Fixed icon typo                |             |                    |<br>
| 2017-09-12 | 2.0     |Rewritten version as R Notebook|             |                    |<br>
| 2017-06-16 | 1.0     |Initial Version                |             |                    |<br>
...
**CABIN_vv_import.Rmd Version 2.1 - August 23, 2019**

Addition of a more robust way to create the spatial data file using both Benthic and Habitat files.

![ACTION:](../../../Configuration/logo_new.png)   **Dialogs** --- Instead of modifying code lines, dialogs are used to define some parameters.

![ACTION:](../../../Configuration/logo_updated.png)   **List of missing spatial coordinates** --- A new list of visits with no spatial coordinates is created.
***
