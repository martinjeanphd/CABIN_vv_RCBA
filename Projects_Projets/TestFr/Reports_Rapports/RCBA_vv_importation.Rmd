...
```{r, include=FALSE}
# Veuillez définir un titre à la présente analyse et identifier la plate-forme que vous utilisez.

#Modifiez au besoin les lignes de code suivantes et exécutez-les.
datasetName <- "Webinaire 1 sur données exemples"
...
Ce rapport traite de l'importation des données du projet **`r paste(datasetName)`**.
...
paste("Fichier de coordonnées géographique créé à partir d'un extrait du fichier", bioFilename)
spaFilename <- paste("Extrait de ", bioFilename, sep="")
...
|    Date    | Version |      Description     | Approbation | Date d'approbation |
|:-----------|:-------:|:---------------------|:-----------:|:------------------:|
| 2017-09-12 | 2.0     |Version réécrite sous forme de carnet R      |             |                   |
| 2017-06-16 | 1.0     |Version initiale      |             |                   |
