...
Ce document est un carnet de notes écrit en [Markdown R](http://rmarkdown.rstudio.com). Lorsque vous éxécuter le code intégré au carnet, les résulats apparaitront sous le code correspondant.
...
print(moran.test)
sp.correlogram(lwW, dataset.BIO2, order=15, method="I", randomisation=FALSE)

}

#ajout d'un corrélogramme
sp.correlogram(lwW, dataset.BIO2, order=15, method="I", randomisation=FALSE)
