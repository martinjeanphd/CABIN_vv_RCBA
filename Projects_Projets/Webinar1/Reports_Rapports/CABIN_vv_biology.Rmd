...
> 
> 
> - *Is the distribution of abundance values indicating an ecological phenomemon or a potential problem (disturbance)?*
...
The following correlation matrix (or *corrgram*) illustrates by the intensity of the color the correlation force that exists between two taxa with abundance values equivalent to 0. A white color indicates a correlation force that tends to a value of 0.5 whereas a dark blue color indicates a correlation force that tends to a value of 1. This matrix also illustrates the proportion of correlation values. 0 abundances of a taxon relative to all abundance values observed in the latter. Only taxa present in more than 25% of the visits are shown.
...
```{r, echo=FALSE}
#Q-Q plots and frewuency distribution histograms
