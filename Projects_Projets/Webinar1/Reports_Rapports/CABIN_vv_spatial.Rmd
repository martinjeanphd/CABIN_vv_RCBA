...
```{r include=FALSE, message=FALSE, warning=FALSE, r include=FALSE}
## Required Packages and Custom Functions
source("../../../Required_packages.R")
source("../../../Required_functions.R")
#source("../../../Functions_Fonctions/functions.R")
...
In this analysis, the genaral dataset is checked to answer the following question:
