...
This report presents the results for verification and validation of a biological CABIN data file associated to the project **`r paste(analysisTitle)`**.
...
## Create a folder, if needed, for saving results
 ifelse(dir.exists("Results_biology"),"",dir.create("Results_biology"))
