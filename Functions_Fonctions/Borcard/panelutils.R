...
#
## Placer les corrélations de Pearson, Spearman ou Kendall dans la partie supérieure
...
#
## Placer les histogrammes dans la diagonale
...
#
## Ajouter les courbres noires lowess dans les diagrammes de dispersion
